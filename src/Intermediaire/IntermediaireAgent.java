		...
		parallelBehaviour.addSubBehaviour(new CyclicBehaviour() {
			...
			public void action() {
				...
				else if (aclMessage11 != null)
				{
					...
					String model = aclMessage11.getUserDefinedParameter("model");
					String type = aclMessage11.getUserDefinedParameter("type");
					String year = aclMessage11.getUserDefinedParameter("year");
					String engine_type = aclMessage11.getUserDefinedParameter("engine_type");
					
					System.out.println("intermediaire : " + brand + model + type + year+ engine_type);
					*/// List<String> infoo = new ArrayList<String>();
					...
					try {
						...
						aclMessage2.addUserDefinedParameter("model", model);
						aclMessage2.addUserDefinedParameter("year", year);
						aclMessage2.addUserDefinedParameter("type", type);
						aclMessage2.addUserDefinedParameter("engine_type", engine_type);*/
